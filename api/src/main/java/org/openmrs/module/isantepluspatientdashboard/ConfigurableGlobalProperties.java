...
public class ConfigurableGlobalProperties {
	...
	public static String FORMSTATUS_CONCEPTID = "isantepluspatientdashboard.formStatusConceptId";

	public static String YES_CONCEPTID = "isantepluspatientdashboard.yesConceptId";

	public static String NO_CONCEPTID = "isantepluspatientdashboard.noConceptId";
