...
public class IsantePlusMetadataBundle extends AbstractMetadataBundle {
	...
	public void install() {
		...
		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_LOCAL_MPI_IDENTIFIERTYPEMAP_Biometrics_Reference_Code, IsantePlusConstants.HaitiCore_BIOMETRIC_UUID + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_Biometrics_Reference_Code_UNIVERSAL_IDENTIFIER + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_M2Sys_Fingerprint_Registration_ID_UNIVERSAL_IDENTIFIER_TYPE);
