<%  if (isActiveVisit) {  %>
	<div class="info-section">
	    ...
	    <div class="info-body">
	    	<h4 id="togglePrimaryCareForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.primaryCare") }</h4>
	    	<ul id="primaryCareForms">
		 	...
		 	<h4 id="toggleLabForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.lab") }</h4>
	    	<ul id="labForms">
			    <% labForms.each { %>
			    	<li><a href="${ ui.format(it.url) }">${ ui.format(it.name) }</a></li>
			 	<% } %>
		 	...
		 	<%  if (showObygnForms) {  %>
			 	<h4 id="toggleObygnForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.obygn") }</h4>
		    	<ul id="obygnForms">
				    <% obygnForms.each { %>
				    	<li><a href="${ ui.format(it.url) }">${ ui.format(it.name) }</a></li>
					 <% } %>
			...
			<% } %>
		 	...
		 	<h4 id="toggleHivCareForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.hivCare") }</h4>
	    	<ul id="hivCareForms">
			    <% hivCareForms.each { %>
			    	<li><a href="${ ui.format(it.url) }">${ ui.format(it.name) }</a></li>
			 	<% } %>
		 	...
		 	<h4 id="togglePsychoSocialForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.psychoSocial") }</h4>
	    	<ul id="psychoSocialForms">
		 	...
		 	<h4 id="toggleOtherForms" style="cursor:pointer;">${ ui.message("isanteplus.isanteForms.categories.other") }</h4>
	    	<ul id="otherForms">
			    <% otherForms.each { %>
			    	<li><a href="${ ui.format(it.url) }">${ ui.format(it.name) }</a></li>
				<% } %>
