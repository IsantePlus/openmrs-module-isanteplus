...
<input type="checkbox" class="managerOption" id="${manager.lastDrugsExtensionId}" ${manager.lastDrugsExtensionChecked}> ${ ui.message('isantepluspatientdashboard.manageIsantePlusPatientDashboard.enableLastDrugs') }<br />
